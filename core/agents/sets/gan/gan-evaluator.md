---
name: gan-evaluator
description: GAN Harness — Evaluator agent. Tests the live running application via Playwright, scores against rubric, and provides actionable feedback to the Generator. Use when the task calls for a gan evaluator.
model: sonnet
