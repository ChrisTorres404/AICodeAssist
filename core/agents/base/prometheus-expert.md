...
description: Prometheus expert covering metric design, exporters, PromQL, recording and alerting rules, and cardinality control. Use PROACTIVELY when adding metrics, writing alerts, or debugging monitoring gaps.
model: sonnet
---
