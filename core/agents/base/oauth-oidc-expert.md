...
description: OAuth 2.0 and OpenID Connect expert covering authorization flows, PKCE, token exchange, discovery, and standards compliance. Use PROACTIVELY for any OAuth or OIDC implementation, or identity federation work.
model: sonnet
---
