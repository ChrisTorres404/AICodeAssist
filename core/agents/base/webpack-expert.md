---
name: webpack-expert
description: Webpack expert covering bundling, code splitting, loaders, plugins, tree shaking, and build performance. Use PROACTIVELY when build configuration, bundle size, or compile time is in question.
model: sonnet
---
