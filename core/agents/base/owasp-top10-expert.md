...
description: OWASP Top 10 security expert for identifying and mitigating critical web application risks. Use PROACTIVELY when reviewing code for vulnerabilities, threat modelling, or hardening an endpoint.
model: sonnet
---
