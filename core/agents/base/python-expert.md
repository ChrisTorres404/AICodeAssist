---
name: python-expert
description: Python architect for idiomatic code, async patterns, packaging, performance, and testing. Use PROACTIVELY for any Python module, script, or backend service.
model: sonnet
---
