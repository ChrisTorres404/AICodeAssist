...
description: Legacy AngularJS expert for maintaining, debugging, and migrating existing AngularJS 1.x applications. Use when working on AngularJS code or planning a migration off it.
model: sonnet
---
