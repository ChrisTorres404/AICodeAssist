---
name: redis-expert
description: Redis expert covering data structures, caching strategies, eviction, persistence, pub/sub, and cluster behaviour. Use PROACTIVELY for any caching layer, rate limiter, session store, or Redis-backed queue.
model: sonnet
---
