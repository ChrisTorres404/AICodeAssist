...
description: WebSocket expert covering connection lifecycle, backpressure, reconnection, scaling, and real-time protocol design. Use PROACTIVELY for any real-time feature, live update channel, or socket server.
model: sonnet
---
