---
name: nextjs-expert
description: Next.js architect covering App Router, server components, rendering strategies, data fetching, and deployment. Use PROACTIVELY for any Next.js route, layout, server action, or full-stack React work.
model: sonnet
---
