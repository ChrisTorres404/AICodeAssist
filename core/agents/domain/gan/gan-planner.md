---
name: gan-planner
description: GAN Harness — Planner agent. Expands a one-line prompt into a full product specification with features, sprints, evaluation criteria, and design direction. Use when the task calls for a gan planner.
model: opus
