---
name: gan-generator
description: GAN Harness — Generator agent. Implements features according to the spec, reads evaluator feedback, and iterates until quality threshold is met. Use when the task calls for a gan generator.
model: sonnet
