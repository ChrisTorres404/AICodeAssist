...
- Use `search-first` before relying on evolving ML serving, vector DB, feature store, or eval-framework APIs.
...
See the project's ML pipeline conventions in its `CLAUDE.md`.
