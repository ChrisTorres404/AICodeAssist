---
description: Carry a verified, closed work order or bug into the project's playbooks with a catalog entry and pitfalls. Usage: /promote WO-#### | /promote BUG-####
---
...
2. Open the playbook's `CATALOG.md` and write the **Pitfalls** lines for this
...
3. Report the playbook, the folder, and the pitfalls you recorded.
