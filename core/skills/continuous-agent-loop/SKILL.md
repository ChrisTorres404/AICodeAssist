...
1. RFC decomposition (`work-order` — one work order per deliverable)
2. quality gates (the quality-gate and evidence-gate hooks)
3. eval loop (`eval-harness`)
4. session persistence (`session-handoff`)
