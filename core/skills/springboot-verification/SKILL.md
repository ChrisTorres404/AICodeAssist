...
description: "Verification loop for Spring Boot projects: build, static analysis, tests with coverage, security scans, and diff review before release or PR. Use when the task calls for springboot verification."
---
...
```bash
mvn -T 4 test
mvn jacoco:report   # verify executed behavioural evidence (see the testing rule)
# or
