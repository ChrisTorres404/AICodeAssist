...
description: Worked Dart and Flutter test examples covering BLoC and Riverpod unit tests, widget tests, fakes, fake_async, golden tests, and test naming. Use when writing Dart or Flutter tests — unit, widget, golden, or async.
---

# Dart/Flutter Testing Patterns
