...
For a release that publishes packages or tags, write the release checklist into the work order's SPEC before mutating tags, registry dist-tags, or GitHub Releases: exact green main, signed tag, registry read-back, and the announcement.
