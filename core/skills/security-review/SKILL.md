...
- [ ] the database queries properly sanitized
...
#### Row Level Security (the database)
```sql
...
- [ ] Row Level Security enabled in the database
...
- [the database Security](https://the database.com/docs/guides/auth)
