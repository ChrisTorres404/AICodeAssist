...
description: PostgreSQL database patterns for query optimization, schema design, indexing, and security. Use when designing PostgreSQL schemas, indexes, or RLS policies, or when a query is too slow.
---
