...
```bash
bash {{PIPELINE_ROOT}}/skills/rules-distill/scripts/scan-skills.sh
```

#### 1b. Collect rules index

```bash
bash {{PIPELINE_ROOT}}/skills/rules-distill/scripts/scan-rules.sh
```
...
Draft:
  ...
  See the merge discussion above
