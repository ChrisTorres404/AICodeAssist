---
name: search-first
description: Research-before-coding workflow. Search for existing tools, libraries, and patterns before writing custom code. Runs the search through a general-purpose subagent. Use when the task calls for search first.
---
...
├─────────────────────────────────────────────┤
│  2. PARALLEL SEARCH (general-purpose subagent)      │
│     ┌──────────┐ ┌──────────┐ ┌──────────┐  │
│     │  npm /   │ │  MCP /   │ │  GitHub / │  │
│     │  PyPI    │ │  Skills  │ │  Web      │  │
│     └──────────┘ └──────────┘ └──────────┘  │
...
| Skills directory | `ls {{PIPELINE_ROOT}}/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
2. Is there an MCP for this? → Check `{{PIPELINE_ROOT}}/settings.json` and search
3. Is there a skill for this? → Check `{{PIPELINE_ROOT}}/skills/`
4. Is there a GitHub implementation/template? → Run GitHub code search for maintained OSS before writing net-new code

### Full Mode (agent)

For non-trivial functionality, launch a general-purpose subagent with WebSearch and the codebase:
...
### AI/LLM Integration
- Claude SDK → the official documentation for latest docs
