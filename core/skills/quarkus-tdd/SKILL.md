...
TDD guidance for Quarkus 3.x services with executed behavioural evidence (see the testing rule) (unit + integration). Optimized for event-driven architectures with Apache Camel.
