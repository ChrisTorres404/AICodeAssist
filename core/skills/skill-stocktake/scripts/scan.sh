...
#
# Environment:
#   SKILL_STOCKTAKE_GLOBAL_DIR   Override {{PIPELINE_ROOT}}/skills (for testing only;
...
date_ago() {
  ...
  date -u -d "${n} days ago" +%Y-%m-%dT%H:%M:%SZ   # portability-ok: date-flags — BSD -v above runs first
}
