...
> Extends the this pipeline philosophy to ship-grade concerns that style/pattern rules cannot encode by themselves.
...
- [ ] `tsc --noEmit` clean
- [ ] `npx expo lint` clean
- [ ] Tests green and executed against a running build (see testing.md)
