...
This is the operator wrapper around the repo's research stack. It is not a replacement for web research or `market-research`; it tells you when and how to use them together.

## Skill Stack

Pull these pipeline-native skills into the workflow when relevant:

- WebSearch for fast current-web discovery
- a multi-source research pass (WebSearch plus WebFetch) for synthesis with citations
...
- use WebSearch for fast discovery
- escalate to a multi-source research pass when synthesis or multiple sources matter
