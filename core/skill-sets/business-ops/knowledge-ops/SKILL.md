...
- Syncing knowledge across systems (local files, MCP memory, the database, Git repos)
...
- **Path:** `{{PIPELINE_ROOT}}/projects/*/memory/`
...
### Layer 5: External Data Store (the database, PostgreSQL, etc.)
...
Write to {{PIPELINE_ROOT}}/projects/*/memory/ for cross-session recall
