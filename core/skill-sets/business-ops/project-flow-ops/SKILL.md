...
- External-source features should be rebuilt inside the project when they are valuable but not self-contained
...
- "Map GitHub issues into our the current release and the next major release program lanes"
