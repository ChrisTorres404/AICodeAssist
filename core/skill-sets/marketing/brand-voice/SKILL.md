...
5. If site copy matters, include the product's landing page and repository framing.
...
If the user wants the default voice and live sources are thin, start here unless newer source material overrides it:
