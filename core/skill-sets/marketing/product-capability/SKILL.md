...
description: Translate PRD intent, roadmap asks, or product discussions into an implementation-ready capability plan that exposes constraints, invariants, interfaces, and unresolved decisions before multi-service work starts. Use when the user needs a pipeline-native PRD-to-SRS lane instead of vague planning prose.
---
...
If useful, point to the next pipeline-native lane:
...
HANDOFF
- what should happen next and which pipeline lane should take it
```
...
- The resulting plan is reusable across Claude Code, Codex, Cursor, OpenCode, and other planning surfaces.
