---
name: messages-ops
description: Evidence-first live messaging workflow . Use when the user wants to read texts or DMs, recover a recent one-time code, inspect a thread before replying, or prove which message source was actually checked.
---
...
- `social-graph-ranker` when the DM thread belongs to outbound network work
